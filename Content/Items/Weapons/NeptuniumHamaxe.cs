...
namespace YeeHaw.Content.Items.Weapons
{
    public class NeptuniumHamaxe : ModItem
    {
        ...
        {
            // DisplayName.SetDefault("Neptunium Hamaxe"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.

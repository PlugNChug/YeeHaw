	...
	public class TriangleSlime : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			...
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Mutations cause some slimes to become triangular. These pointy slimes can be found on the Surface during both day and night."),
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
			...
			npcLoot.Add(ItemDropRule.Common(ItemID.PinkGel, 4));
		}
    }
}
